...
__license__ = 'MIT'
__date__ = 'Thu 07 Jul 22 13:03:37'
__version__ = '1.0'
...
def import_tower(file, skiprows=[1], parse_dates=[[2,3]], delim_whitespace=True, 
                 utc_offset=-8, tz_name='America/Los_Angeles', **kwargs):
    """
    ...
    **kwargs
    ...
    df.date_time = df.date_time.apply(utils.make_tzaware, utc_offset=utc_offset, tz_name=tz_name)
